...
1. cadastrar o nome de um aluno;
2. receber duas notas;
3. calcular a média;
4. verificar se o aluno foi aprovado, está em recuperação ou foi reprovado;
...
Crie um pequeno sistema com funções para:

- cadastrar o nome de um aluno;
- receber duas notas;
- calcular a média;
...
situacao = verificar_maioridade(20)
print(situacao)
```
...
situacao = verificar_aprovacao(6)
print(situacao)
```
...
lista = ["Mouse", "Teclado", "Monitor", "Notebook"]
...
```python
def converter_para_maiusculo(palavra):
    return palavra.upper()

resultado = converter_para_maiusculo("python")
print(resultado)
```
...
Crie um sistema simples de produtos com funções para:

1. cadastrar o nome do produto;
2. cadastrar o preço;
3. calcular desconto;
4. mostrar o preço final;
5. exibir uma mensagem informando se o produto está caro ou barato.

Critério sugerido:

- preço final maior ou igual a 100: `Produto caro`;
- preço final menor que 100: `Produto barato`.
